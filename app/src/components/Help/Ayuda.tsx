    ...
    const faqItems = [
        {
            ...
            answer: "En la parte inferior de iniciar sesion selecciona cambiar contraseña, llena el formulario. Posteriormente se enviara un correo en donde podrás cambiar la contraseña."
        },
        {
            question: "¿Ejemplo?",
            answer: "Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta"
        },
        {
            question: "¿Ejemplo3?",
            answer: "Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta, Ejemplo de respuesta"

...
const Preguntas = () => {
  ...
  const botonesActuales = botones.slice(pagina * botonesPorPagina, (pagina + 1) * botonesPorPagina);
  ...
  const agregarBoton = () => {
    const nuevaOpcion = {
      id_contenido: botones.length + 1,
      pregunta: `Pregunta ${botones.length + 1}`,
    ...
    <div className="preg-container">
      ...
      <div className="preg-content">
        <div className="preg-iz">
          <img src="https://i.imgur.com/ShRoswn.png" alt="Imagen de ejemplo" className="imagen-preg-iz" />
        </div>
        <div className="preg-der">
          <div className="top-p">
            <button className="buuton-preg" onClick={paginaAnterior} disabled={pagina === 0}>
            ...
            <button className="buuton-preg" onClick={siguientePagina} disabled={pagina === maxPaginas - 1}>
          ...
          <div className="bottom-p">
            <div className="avip">
              <div className="texp">
                Si tienes una pregunta y no se encuentra en el listado te invitamos a enviarnos un mensaje en el buzón
                de ayuda.
              </div>
              <a href="/buzon">

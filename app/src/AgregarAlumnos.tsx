...
export default function AgregarAlumnos() {
    ...
    const handleAgregar = () => {
        ...
        console.log('Valores ingresados:', { email, nombre, Papellido, Sapellido, boleta, carrera, planestudio });
...
<div className="tit-pr">Alumnos</div>
            <div className="cont-pr">Agrega a los alumnos que participarán en el protocolo</div>
        ...
        <div className="popup-background" onClick={togglePopup}>
          <div className="popup" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="item3">
              <div className="tit-1">Correo Institucional <input type="email" placeholder="Ingresa el correo institucional del alumno" value={email} onChange={(e) => setEmail(e.target.value)} />
              <button>Buscar</button>
              <div className="adven"><FontAwesomeIcon icon={faCircleExclamation} className="adv-icon" /> 
              El correo institucional que has buscado no se encuentra registrado en la aplicación. Se enviará una notificación a su correo electrónico, o en cualquier otro caso acude directamente a la CATT.
              </div>
              </div>
              ...
              <div className="tit-2">Boleta <input type="text" placeholder="Boleta" value={boleta} onChange={(e) => setBoleta(e.target.value)} /></div>
              <div className="tit-2">Carrera <div><select value={carrera} onChange={(e) => setCarrera(e.target.value)}>
                <option value="">Selecciona la carrera a la que pertenece el alumnno</option>
              ...
              <div className="tit-2">Plan de estudio <div><select value={planestudio} className="ojio" onChange={(e) => setPlanestudio(e.target.value)}>
                <option value="">Selecciona el plan al que pertenece el alumnno</option>
